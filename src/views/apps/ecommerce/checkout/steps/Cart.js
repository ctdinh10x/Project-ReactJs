...
const Cart = props => {
  ...
  const SaveToPDF = () =>{
    ...
    products.forEach(function (obj) {
        ...
        // Chèn canvas vào tài liệu PDF
        var imageData = canvas.toDataURL('image/jpeg');
        console.log(imageData);
        doc.addImage(imageData, 'JPEG', x, y, 200, 200);
  
        doc.text(x + 200 + 10, y + 10, "Brand: " + obj.brand)
        doc.text(x + 200 + 10, y + 30, "Name: " + obj.name)
        doc.text(x + 200 + 10, y + 50, "Description: " + "Thông tin sản phẩm")
        doc.text(x + 200 + 10, y + 70, "Price: " + obj.price)
        doc.text(x + 200 + 10, y + 90, "Rating: " + obj.rating)
        y += 200 + 10;
        if(y>720){
            doc.addPage();
            y=10;
  ...
  return (
    <div className='list-view product-checkout'>
      ...
      {/* nút sự kiện */}
      <button onClick={SaveToPDF}>Hiển thị danh sách products</button>
      <button onClick={Display}>Hiển thị</button>
    </div>
  )
}
