...
// LicensePage 
const LicensePage = lazy(() => import('../../views/pages/licensePage'))
...
const AlarmReport = lazy(() => import('../../views/pages/alarms'))
const DetectPerson = lazy(() => import('../../views/pages/detect-person'))
...
const PagesRoutes = [
  ...
  {
    path: '/pages/alarm-report',
    element: <AlarmReport />
  },
  {
    path: '/pages/detect-person',
